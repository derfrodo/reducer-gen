...
`;
    ...
    getGeneralGenertedFileInformation(): string {
        return `// This file has been generated by reducer-gen (@Stefan Pauka) written in 2020 / 2021 / 2022 / 2023 (times runs ... ;) ).
`;
    }
...
`,
    ...
    getPascalCasedFeatureName(stateInfo: StateInterfaceInfo): string {
        const { toPascalCased } = this.stringHelper;
